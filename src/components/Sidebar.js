...
function Sidebar({ nama, nip, unit }) {
  ...
  return (
    <div>
      ...
      >
        {/* Brand Logo */}
        <Link to="/apdashboard" className="brand-link">
          <img
            src="/angkasapura/ap_logo.png"
            alt="AP Logo"
        ...
        <div className="sidebar">
          ...
          <div className="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div className="info">
              <div className="d-block">{nama}</div>
              <div className="d-block">{unit}</div>
              <Link to="/change-password" className="d-block btn btn-link p-0 mt-4">
                Change Password
              </Link>
            </div>
          </div>
          ...
          <nav className="mt-2">
            ...
            >
              <li className="nav-item">
                <Link to="/apdashboard" className="nav-link">
